...
export declare class PackVRF implements UpdateableNetwork, DetectableFeature {
    ...
    chainId: number;
    private events;
    constructor(network: NetworkOrSignerOrProvider, address: string, storage: ThirdwebStorage, options: SDKOptions, chainId: number, contractWrapper?: ContractWrapper<PackVRFDirect>);
