...
var thirdwebCheckout = require('./thirdweb-checkout-e9dbe098.cjs.prod.js');
...
class PackVRF {
  constructor(network, address, storage, options, chainId) {
    ...
    defineProperty._defineProperty(this, "featureName", thirdwebCheckout.FEATURE_PACK_VRF.name);
...
class Pack extends thirdwebCheckout.StandardErc1155 {
  ...
  constructor(network, address, storage) {
    ...
    defineProperty._defineProperty(this, "_vrf", void 0);
    this.abi = abi;
